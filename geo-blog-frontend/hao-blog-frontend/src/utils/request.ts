...
class Request {
  ...
  constructor() {
    ...
    this.instance.interceptors.request.use(this.handleRequestIntercept, this.handleRequestInterceptError)
  }

  private handleRequestIntercept(config: AxiosRequestConfig): AxiosRequestConfig {
